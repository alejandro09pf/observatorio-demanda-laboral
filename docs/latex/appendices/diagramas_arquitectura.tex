...
\subsection*{D.3. Diagrama de Flujo de Transformación de Datos}

La Figura \ref{fig:flujo-transformacion-anexo} ilustra el flujo detallado de transformaciones que sufren los datos desde la recolección inicial hasta la generación de visualizaciones finales, mostrando las estructuras de datos intermedias y los puntos de persistencia en PostgreSQL.

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{diagrams/flujo_transformacion.png}
\caption{Flujo de Transformación de Datos a través del Pipeline Completo}
\label{fig:flujo-transformacion-anexo}
\end{figure}
