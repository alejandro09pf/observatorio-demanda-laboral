#!/usr/bin/env python3
"""
Debug script for Bumeran spider
...
def run_bumeran_debug():
    """Run Bumeran spider debug test."""
    ...
    # Create a test Bumeran spider that works with the current structure
    class TestBumeranSpider(Spider):
        name = "bumeran"
        ...
        def __init__(self, *args, **kwargs):
            ...
            if self.country == "AR":
                ...
                self.start_urls = ["https://www.bumeran.com.ar/empleos"]
            ...
            test_jobs = [
                {
                    ...
                    'url': 'https://www.bumeran.com.ar/empleo/desarrollador-full-stack-123',
                    'description': 'Buscamos un desarrollador Full Stack con experiencia en React y Node.js',
                    'requirements': 'React, Node.js, MongoDB, 3+ años de experiencia',
                ...
                },
                {
                    ...
                    'company': 'SistemasPro S.A.',
                    'location': 'Córdoba, Argentina',
                    'url': 'https://www.bumeran.com.ar/empleo/analista-sistemas-456',
                    'description': 'Analista de sistemas para proyectos de desarrollo',
                    'requirements': 'SQL, Java, análisis de requerimientos',
                    'salary_raw': 'ARS 150000-200000',
                    'contract_type': 'Tiempo completo',
                ...
                },
                {
                    ...
                    'url': 'https://www.bumeran.com.ar/empleo/devops-engineer-789',
    ...
    # Add the spider
    process.crawl(TestBumeranSpider, country='AR', max_pages=2)
    
    # Start the crawling
    print("=" * 60)
    print(" Starting Bumeran Spider Debug Test")
    print("=" * 60)
    ...
    try:
        ...
        if items:
            ...
            output_file = output_dir / "bumeran_test.json"
            ...
            print("\n🎉 The Bumeran spider structure is working correctly!")
