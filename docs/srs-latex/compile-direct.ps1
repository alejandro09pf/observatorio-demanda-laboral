# Script PowerShell para compilar el documento SRS
# Navegar al directorio del documento
Set-Location "C:\Users\PcMaster\Documents\GitHub\observatorio-demanda-laboral\docs\srs-latex"

Write-Host "============================================================"
Write-Host "Compilando SRS - Especificacion de Requerimientos de Software"
Write-Host "============================================================"
Write-Host ""
