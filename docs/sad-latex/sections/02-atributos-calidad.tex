...
\hline
\textbf{Estímulo} & Ejecución del matcher de 2 capas (exact a fuzzy con threshold 0.92, semantic deshabilitada) \\
\hline
\textbf{Artefacto} & Módulo esco\_matcher\_3layers.py (2 capas activas) con búsquedas SQL y fuzzywuzzy \\
\hline
