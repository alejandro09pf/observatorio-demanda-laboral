...
El análisis de clustering sobre el corpus completo de 30,660 ofertas procesadas con Pipeline A generó 53 clusters interpretables a partir de 1,698 skills únicas Post-ESCO (configuración: n\_neighbors=15, min\_cluster\_size=12), con Silhouette Score de 0.456 y 22.3\% de ruido. El sistema implementó clustering jerárquico de dos niveles: 53 fine-clusters representando familias tecnológicas específicas, y 4 meta-clusters agrupando clusters relacionados (META-0: conceptos generales, META-1: skills especializadas, META-2: tecnologías core, UNCLUSTERED: frameworks específicos). La configuración Pipeline A 30k PRE-ESCO produjo 2,044 clusters reflejando granularidad máxima del vocabulario técnico sin normalización taxonómica.

El análisis cualitativo manual de los 50 clusters más significativos (exp15: n\_neighbors=15, min\_cluster\_size=15) identificó 14 categorías temáticas dominantes en el mercado laboral tecnológico latinoamericano. Los 15 clusters más demandados concentran 68\% de la demanda total:
