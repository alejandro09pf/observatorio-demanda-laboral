...
\textbf{Taxonomía base:} El sistema utiliza una taxonomía unificada de \textbf{60,000 skills totales}, compuesta por:
\begin{itemize}
    \item \textbf{ESCO v1.1.0:} 60,000 skills (base europea de competencias laborales)
...
\begin{itemize}
    ...
    \item \textbf{Layer 2 - Fuzzy Match:} Similitud difusa con fuzzywuzzy, threshold 0.85, confianza 0.85-1.0
