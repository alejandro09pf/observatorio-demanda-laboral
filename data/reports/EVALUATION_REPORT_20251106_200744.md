...
|----------|-----------|--------|----------|---------|----------|
| Pipeline A (NER+Regex) (hard)  | 0.2201 | 0.2802 | 0.2466 | 1888 | 2403 |

**Ganador:** Pipeline A (NER+Regex) (hard) (F1=0.2466)
...
|----------|-----------|--------|----------|----------------|
| Pipeline A (NER+Regex) (hard)  | 0.6550 | 0.8125 | 0.7253 | 11.53% |

**Ganador:** Pipeline A (NER+Regex) (hard) (F1=0.7253)
...
|----------|------|----------|----------------|
| Pipeline A (NER+Regex) (hard)  | +0.4788 | +194.17% | 2126 |
...
- A Solid Sdlc Understanding Through A Degree In Computer Science Or Related Fields
