...
Scrapes job postings from occ.com.mx
"""
...
class OCCMundialSpider(BaseSpider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.country == "MX":
            self.start_urls = [
                ...
                "https://www.occ.com.mx/empleos/administracion",
                "https://www.occ.com.mx/empleos/ventas"
            ]
        ...
        # Override custom settings for this spider - more conservative due to throttling
    ...
    def parse_search_results(self, response):
        ...
        # Extract job listings - OCCMundial specific selectors
        # Look for cards under results grid
        job_cards = response.css("div[class*='job'], article[class*='job'], div[class*='card'], div[class*='item']")

        if not job_cards:
            # Try alternative selectors for OCCMundial structure
        ...
        for i, job_card in enumerate(job_cards):
            try:
                # Extract job URL - OCCMundial specific patterns
                job_url = (
                ...
                if not any(keyword in job_url for keyword in ['/empleo/', '/trabajo/', '/job/', '/oferta/', '/puesto/', '/vacante/']):
                    continue
        ...
        # Handle pagination - OCCMundial specific patterns
    ...
    def parse_job(self, response):
        ...
        try:
            ...
            # Extract title - OCCMundial specific selectors
            title_selectors = [
                "h1::text",
                "h1.job-title::text",
                ".job-title::text",
            ...
            # Extract company - OCCMundial specific selectors
            company_selectors = [
                ".company::text",
                ".company-name::text",
                ".employer::text",
            ...
            # Extract location - OCCMundial specific selectors
            location_selectors = [
                ".location::text",
                ".place::text",
                ".city::text",
            ...
            # Extract description - OCCMundial specific selectors
            ...
            # Extract requirements - OCCMundial specific selectors
            ...
            # Extract salary - OCCMundial specific selectors
            salary_selectors = [
                ".salary::text",
                ".wage::text",
                ".payment::text",
            ...
            # Extract contract type - OCCMundial specific selectors
            contract_selectors = [
                ".contract-type::text",
                ".type::text",
                ".contract::text",
            ...
            # Extract remote type - OCCMundial specific selectors
            remote_selectors = [
                ".remote::text",
                ".work-mode::text",
                ".modality::text",
            ...
            # Extract posted date - OCCMundial specific selectors
            date_selectors = [
                ".date::text",
                ".posted::text",
    ...
    def parse_date(self, date_string: str) -> Optional[str]:
        """Parse OCCMundial date format."""
        if not date_string:
            return None

        try:
            # Common date patterns in OCCMundial
            date_patterns = [
