\section*{APÉNDICE E: INFORMACIÓN ADICIONAL SOBRE BASE DE DATOS}
\addcontentsline{toc}{section}{Apéndice E: Información Adicional sobre Base de Datos}

Este apéndice proporciona información complementaria sobre el diseño de la base de datos presentado en el Capítulo 5 (Figura \ref{fig:diagrama-er}). Se detallan las especificaciones completas de cada tabla, los índices optimizados para procesamiento batch, la configuración de PostgreSQL para manejo de grandes volúmenes de datos, y las estrategias de persistencia y trazabilidad implementadas.

\subsection*{E.1. Especificación Detallada de Tablas}

El diagrama entidad-relación presentado en el Capítulo 5 muestra las seis tablas principales del sistema. Esta sección documenta la especificación completa de campos, tipos de datos, índices y volúmenes para cada tabla.

\subsubsection*{E.1.1. Tabla raw\_jobs}
...
\subsubsection*{E.1.2. Tabla extracted\_skills}
...
\subsubsection*{E.1.3. Tabla enhanced\_skills}
...
\subsubsection*{E.1.4. Tabla skill\_embeddings}
...
\subsubsection*{E.1.5. Tabla analysis\_results}
...
\subsubsection*{E.1.6. Tabla esco\_skills}
...
\subsection*{E.2. Configuración de PostgreSQL para Procesamiento Batch}
...
\subsubsection*{E.2.1. Configuración de Memoria}
...
\subsubsection*{E.2.2. Resultados de las Optimizaciones}
...
\subsection*{E.3. Estrategias de Persistencia y Trazabilidad}
