...
\textbf{Capacidades validadas del sistema}:

Las 8 configuraciones de producción validaron tres capacidades críticas: (1) \textit{Escalabilidad}: procesamiento exitoso de 98,829 skills únicas en $<$10 minutos con métricas aceptables (Silhouette 0.361, Davies-Bouldin 0.735); (2) \textit{Adaptabilidad}: detección automática de 2-2,044 clusters según granularidad de datos sin intervención manual; y (3) \textit{Robustez}: estructura macro de 2 meta-clusters (hard skills técnicos vs. soft skills transversales) persiste consistentemente en todas las escalas y pipelines, confirmando que el sistema captura dicotomía fundamental del mercado laboral.
...
El análisis de clustering sobre el corpus completo de 30,660 ofertas procesadas con Pipeline A generó 53 clusters interpretables a partir de 1,698 skills únicas Post-ESCO (configuración: n\_neighbors=15, min\_cluster\_size=12), con Silhouette Score de 0.456 y 22.3\% de ruido. El sistema detectó automáticamente 2 meta-clusters correspondientes a la dicotomía fundamental hard skills técnicos vs. soft skills transversales. La configuración Pipeline A 30k PRE-ESCO produjo 2,044 clusters reflejando granularidad máxima del vocabulario técnico sin normalización taxonómica.

El análisis detallado de contenido semántico de clusters individuales, incluyendo identificación de dominios tecnológicos específicos (Python/Data Science, Cloud/DevOps, Frontend JavaScript, etc.) y cuantificación de su frecuencia relativa en el corpus, requiere procesamiento cualitativo adicional mediante inspección manual de las 53 agrupaciones. Los clusters generados automáticamente por HDBSCAN garantizan cohesión interna (skills similares agrupadas) y separación entre grupos, pero la asignación de etiquetas interpretables y la medición de demanda por dominio tecnológico constituyen trabajo futuro documentado en el Capítulo 8.
