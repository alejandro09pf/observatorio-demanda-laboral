...
Este trabajo demuestra empíricamente la viabilidad y superioridad de los LLMs para extracción de habilidades técnicas en el contexto latinoamericano. La mejora de 16.2\% en F1-Score respecto a métodos tradicionales, combinada con la capacidad de detectar habilidades emergentes ausentes en taxonomías oficiales, establece fundamentos cuantitativos sólidos para esta conclusión.
